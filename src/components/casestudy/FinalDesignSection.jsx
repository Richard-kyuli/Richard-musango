          ...
          user: [
            {
              id: 1,
              badge: "SCREEN 1",
              title: "Buy & Sell User Screen 1",
              description: "First user interface screen showing the initial view or landing page of the Buy & Sell marketplace. Displays primary navigation, featured content, and entry points for key user actions.",
              features: ["Main interface", "Navigation elements", "Featured content"],
              image: "/Buysell/1.png",
              alignment: "left",
              deviceType: "mobile"
            },
            {
              id: 2,
              badge: "SCREEN 2",
              title: "Buy & Sell User Screen 2",
              description: "Second user interface screen displaying product browsing or category selection interface. Shows organized content structure with filtering and navigation options.",
              features: ["Browse interface", "Category view", "Filter options"],
              image: "/Buysell/2.png",
              alignment: "right",
              deviceType: "mobile"
            },
            {
              id: 3,
              badge: "SCREEN 3",
              title: "Buy & Sell User Screen 3",
              description: "Third user interface screen showing detailed product view or listing creation interface. Displays form fields, input areas, and interactive elements for user engagement.",
              features: ["Detailed view", "Input fields", "Interactive elements"],
              image: "/Buysell/3.png",
              alignment: "left",
              deviceType: "mobile"
            },
            {
              id: 4,
              badge: "SCREEN 4",
              title: "Buy & Sell User Screen 4",
              description: "Fourth user interface screen presenting additional functionality or workflow continuation. Shows progression through the user journey with relevant controls and information.",
              features: ["Workflow step", "User controls", "Progress indication"],
              image: "/Buysell/4.png",
              alignment: "right",
              deviceType: "mobile"
            },
            {
              id: 5,
              badge: "SCREEN 5",
              title: "Buy & Sell User Screen 5",
              description: "Fifth user interface screen displaying advanced features or additional user options. Provides extended functionality and supplementary tools for enhanced user experience.",
              features: ["Extended features", "Additional options", "Enhanced controls"],
              image: "/Buysell/5.png",
              alignment: "left",
              deviceType: "mobile"
            },
            {
              id: 6,
              badge: "SCREEN 6",
              title: "Buy & Sell User Screen 6",
              description: "Sixth user interface screen showing continued user flow or alternative view. Presents complementary functionality and related features within the application.",
              features: ["Flow continuation", "Alternative view", "Related features"],
              image: "/Buysell/6.png",
              alignment: "right",
              deviceType: "mobile"
            },
            {
              id: 7,
              badge: "SCREEN 7",
              title: "Buy & Sell User Screen 7",
              description: "Seventh user interface screen completing the user journey or showing final state. Displays confirmation, summary, or completion elements with next action options.",
              features: ["Journey completion", "Final state", "Next actions"],
              image: "/Buysell/7.png",
              alignment: "left",
              deviceType: "mobile"
            }
