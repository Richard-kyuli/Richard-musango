        ...
        return {
          user: [
            ...
            },
            {
              ...
              description: "First step of posting flow - product photo upload screen with image picker interface. Sellers can select and upload multiple product photos from their gallery. Visual placeholder boxes indicate where photos will appear.",
              features: ["Photo upload interface", "Multiple image selection", "Gallery picker"],
              image: "/Buysell/2.png",
              alignment: "right",
              deviceType: "mobile"
            },
            {
              id: 3,
              badge: "STEP 2",
              title: "Product Details Entry",
              description: "Product information form with fields for title, description, category selection, condition picker, and price input. Sellers enter essential product details to create a complete listing.",
              features: ["Title input", "Description field", "Category dropdown"],
              image: "/Buysell/3.png",
              alignment: "left",
              deviceType: "mobile"
            },
            {
              ...
              description: "Category selection screen with hierarchical category browser and product specifications fields. Sellers choose the most appropriate category and add relevant product attributes or specifications.",
              features: ["Category tree", "Specifications form", "Attributes input"],
              image: "/Buysell/4.png",
              alignment: "right",
              deviceType: "mobile"
            },
            {
              ...
              description: "Pricing setup screen with price input field, negotiation toggle, location picker, and delivery options. Sellers set their asking price and specify where the item is located for buyer convenience.",
              features: ["Price input", "Negotiable toggle", "Location picker"],
              image: "/Buysell/5.png",
              alignment: "left",
              deviceType: "mobile"
            },
            {
              id: 6,
              badge: "REVIEW",
              title: "Listing Preview & Review",
              description: "Preview screen showing how the listing will appear to buyers with all entered information displayed. Sellers can review product photos, title, price, description, and details before publishing. Edit or confirm buttons available.",
              features: ["Listing preview", "All details displayed", "Edit/Confirm options"],
              image: "/Buysell/6.png",
              alignment: "right",
              deviceType: "mobile"
            },
            {
              ...
              description: "Confirmation screen with success message indicating the product is now live on the marketplace. Options to view the published listing, share it, or post another product. Listing ID and publication timestamp shown.",
              features: ["Success confirmation", "View listing button", "Post another option"],
              image: "/Buysell/7.png",
              alignment: "left",
              deviceType: "mobile"
            }
