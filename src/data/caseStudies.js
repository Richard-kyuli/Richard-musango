export const caseStudies = [
  ...
  },
  {
    ...
    finalScreens: [
      { image: '/KRASSP/MacBook Pro 16_ - 21.png', title: 'Dashboard - Quick overview of cumulative savings, recent contributions, and total monthly contributions' },
      { image: '/KRASSP/MacBook Pro 16_ - 22.png', title: 'Payouts - Total disbursements received from savings with recent payouts showing date, amount, period, reference number, and receiving account' },
      { image: '/KRASSP/MacBook Pro 16_ - 23.png', title: 'Inbox - Conversations with the support team recorded in this screen' },
      { image: '/KRASSP/MacBook Pro 16_ - 24.png', title: 'Beneficiaries - List of beneficiaries with their contacts and the percentages they are supposed to receive from the savings' },
      { image: '/KRASSP/MacBook Pro 16_ - 25.png', title: 'Resources - Access resources like Investment Policy Statement Handbook documents and many others, downloadable for reading later' },
      { image: '/KRASSP/MacBook Pro 16_ - 26.png', title: 'Help Center - FAQs and Knowledge Base for KRA, office locations, contacts to the organisation, and socials' },
      { image: '/KRASSP/MacBook Pro 16_ - 27.png', title: 'User Profile - Information about the user, beneficiaries, and accounts' }
    ],
